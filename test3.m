...
Ep = 50000;                                         % Ion beam kinetic enegry [eV]
...
TgPerp = 20;                                        % Gas perpendicular temperature [eV]
...
% nuSinkOld = GetNuSinkCastomIntegration(Vi_list, Nv, np, VTp, Vp, Rp, crossSection);
